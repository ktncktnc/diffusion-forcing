...
python -m main +name=rnn_dmlab_video algorithm=rnn_df_video experiment=exp_video dataset=video_dmlab algorithm.diffusion.num_gru_layers=0 dataset.context_length=4