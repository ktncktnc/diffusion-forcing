...
#SBATCH --output=./logs/rnn_minecraft_smallnetwork.out
#SBATCH --error=./logs/error/rnn_minecraft_smallnetwork.err
...
python -m main +name=rnn_minecraft_video \
        ...
        experiment.training.batch_size=8 experiment.training.max_steps=6000000 experiment.training.lr=1e-4
