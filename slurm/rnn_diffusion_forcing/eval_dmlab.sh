...
python  -m main +name=sample-rnn_df_dmlab-chunk1 algorithm=rnn_df_video experiment=exp_video dataset=video_dmlab experiment.tasks=[validation] \
        ...
        dataset.context_length=0 dataset.validation_multiplier=5 \
        experiment.validation.batch_size=16 experiment.validation.limit_batch=10 \
        algorithm.evaluation.frame_wise=False algorithm.is_teacher_forcing=True \
