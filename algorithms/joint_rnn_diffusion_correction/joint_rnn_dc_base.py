...
class JointRNN_DiffusionCorrectionBase(BasePytorchAlgo):
    ...
    def _preprocess_batch(self, batch, get_zs=True, batch_first=False):
        ...
        Returns:
            Processed tensors for model input in shape (b, t, (fs c), h, w). Keep grad
        """
        n_frames = batch[0].shape[1]
        ...
        if get_zs:
            ...
            pred_xs, xs, zs = self.original_algo(batch, 0, end)
    ...
    def validation_step(self, batch, batch_idx, namespace="validation"):
        ...
        while len(xs_pred) < n_frames - n_context:
            ...
            generation_chunk_size = 1 # chunk = 1 for now
